import { ref, unref, withCtx, createTextVNode, createVNode, toDisplayString, withModifiers, withDirectives, createBlock, openBlock, Fragment, renderList, vModelSelect, createCommentVNode, vModelCheckbox, vModelText, withKeys, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Edit Program" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-7xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="p-6 bg-white border-b border-gray-200"${_scopeId}><div class="flex items-center justify-between mb-6"${_scopeId}><h2 class="text-2xl font-bold text-gray-900"${_scopeId}>Edit Program: ${ssrInterpolate(__props.program.title)}</h2><div class="space-x-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin.programs.show", __props.program.id),
            ...
            if (unref(form).is_workshop) {
              _push2(`<div class="mt-3 p-3 bg-white border border-purple-200 rounded"${_scopeId}><div class="text-xs text-purple-800"${_scopeId}><strong${_scopeId}>Workshop Mode:</strong> This program can have multiple sessions in different locations. Use the <strong${_scopeId}>&quot;Workshop Sessions&quot;</strong> menu to add specific sessions with locations and pricing. </div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<div class="mt-1 text-xs text-gray-600"${_scopeId}> Current number of sold tickets (usually auto-managed). </div>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              class: "mt-2",
                  ...
                  createVNode("div", { class: "bg-white overflow-hidden shadow-sm sm:rounded-lg" }, [
                    createVNode("div", { class: "p-6 bg-white border-b border-gray-200" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-6" }, [
                        createVNode("h2", { class: "text-2xl font-bold text-gray-900" }, "Edit Program: " + toDisplayString(__props.program.title), 1),
                            ...
                            createVNode("div", { class: "bg-purple-50 border border-purple-200 rounded-lg p-4" }, [
                              ...
                              unref(form).is_workshop ? (openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "text-xs text-purple-800" }, [
                                  ...
                                  createTextVNode(" This program can have multiple sessions in different locations. Use the "),
                            ...
                            createVNode("div", { class: "mt-2 space-y-4" }, [
                              imagePreview.value ? (openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "mt-2 flex items-center justify-between" }, [
                                  createVNode("div", { class: "text-sm text-gray-600" }, " Current image • Auto-optimized to 800x600px (4:3 ratio) "),
                                  createVNode("button", {
                                    type: "button",
                        ...
                        createVNode("div", { class: "bg-orange-50 border border-orange-200 rounded-lg p-6" }, [
                          ...
                          createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                            ...
                            createVNode("div", null, [
                              ...
                              createVNode("div", { class: "mt-1 text-xs text-gray-600" }, " Current number of sold tickets (usually auto-managed). "),
                              createVNode(_sfc_main$4, {
                                class: "mt-2",
                                message: unref(form).errors.sold_tickets
                              }, null, 8, ["message"])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Programs/Edit.vue");

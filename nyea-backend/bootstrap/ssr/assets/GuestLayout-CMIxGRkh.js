    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), { href: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/images/logo.svg" alt="Logo" class="h-40 w-40"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: "/images/logo.svg",
      ...
      _push(`</div><div class="w-full overflow-hidden bg-white px-6 py-4 shadow-md sm:max-w-md sm:rounded-lg">`);

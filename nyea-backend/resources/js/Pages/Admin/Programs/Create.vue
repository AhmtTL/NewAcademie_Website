                                        ...
                                        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                                            ...
                                            <div v-if="form.type === 'workshop'" class="mt-3 p-3 bg-white border border-purple-200 rounded">
                                                <div class="text-xs text-purple-800">
                                                    <strong>Workshop Mode:</strong> After creating this program, use the <strong>"Workshop Sessions"</strong> menu to add specific sessions with locations and pricing.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="imagePreview" class="relative">
                                            ...
                                            <div class="mt-2 flex items-center justify-between">
                                                <div class="text-sm text-gray-600">
                                                    Preview • Auto-optimized to 800x600px (4:3 ratio)
                                                </div>
                                                <button
                                                    type="button"
                            ...
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        />
                                        <div class="mt-1 text-xs text-gray-600">
                                            Current number of sold tickets (usually starts at 0).
                                        </div>

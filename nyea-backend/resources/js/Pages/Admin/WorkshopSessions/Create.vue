...
<template>
    ...
    <Head title="Create Workshop Session" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Create Workshop Session</h2>
                                <p class="text-gray-600 mt-1">Add a new session for a workshop in a specific location
                                </p>
                            </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                ...
                                <div>
                                    <InputLabel for="program_id" value="Select Workshop Program" />
                                    ...
                                    <div v-if="selectedWorkshop"
                                        ...
                                        <div class="text-sm text-blue-800">
                                            <strong>Selected:</strong> {{ selectedWorkshop.title }}
                                        </div>
                                        <div class="text-xs text-blue-600 mt-1">
                                            Base Price: ${{ selectedWorkshop.base_price }} • You can override this price
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <TextInput id="location" v-model="form.location" type="text"
                                            class="mt-1 block w-full" placeholder="e.g., NYEA Riyadh Center" required />
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="country" v-model="form.country" type="text"
                                            class="mt-1 block w-full" placeholder="e.g., Saudi Arabia" />
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="country_code" v-model="form.country_code" type="text"
                                            class="mt-1 block w-full" placeholder="e.g., SAU" maxlength="3" />
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <TextInput id="venue_name" v-model="form.venue_name" type="text"
                                            class="mt-1 block w-full" placeholder="e.g., NYEA Middle East Hub" />
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="venue_address" v-model="form.venue_address"
                                            ...
                                            rows="2" placeholder="e.g., King Fahd Road, Riyadh 12234"></textarea>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="mt-1 text-xs text-gray-600">Add special features or benefits specific to
                                        this location</div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="time" v-model="form.time" type="text" class="mt-1 block w-full"
                                            placeholder="e.g., 9:00 AM - 6:00 PM EST" required />
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="timezone" v-model="form.timezone" type="text"
                                            class="mt-1 block w-full" placeholder="e.g., Asia/Riyadh" />
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="price_override" v-model="form.price_override" type="number"
                                            ...
                                            :placeholder="selectedWorkshop ? `Leave empty to use base price ($${selectedWorkshop.base_price})` : 'Override workshop base price'" />
                                        <div class="mt-1 text-xs text-gray-600">
                                            Leave empty to use the workshop's base price
                                            <span v-if="selectedWorkshop" class="font-semibold">(${{
                                                selectedWorkshop.base_price }})</span>
                                        </div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <textarea id="special_notes" v-model="form.special_notes"
                                            ...
                                            rows="3"
                                            placeholder="Any special information about this session location..."></textarea>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <button @click="submitAndPublish" 
                                        :disabled="form.processing"
                                        :class="{ 'opacity-50 cursor-not-allowed': form.processing }"
                                        class="inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
const togglePublish = () => {
    ...
    if (confirm(`Are you sure you want to ${action} this training camp session?`)) {
        router.post(route('admin.training-camp-sessions.toggle-publish', props.session.id));
    }
};
...
<template>
    <Head title="Training Camp Session Details" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Training Camp Session Details</h2>
                                <p class="text-gray-600 mt-1">🏕️ {{ session.program?.title }}</p>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <Link
                                    :href="route('admin.training-camp-sessions.edit', session.id)"
                                    class="bg-orange-600 hover:bg-orange-700 text-white font-medium py-2 px-4 rounded transition-colors"
                                >
                                    Edit Session
                                </Link>
                                <Link
                                    :href="route('admin.training-camp-sessions.index')"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                    <h3 class="text-lg font-semibold text-orange-900 mb-4">⛰️ Location Details</h3>
                                    <div class="space-y-3">
                                        <div>
                                        ...
                                        <div v-if="session.school">
                                            <label class="text-sm font-medium text-gray-700">Associated School</label>
                                            <div class="text-gray-900 flex items-center">
                                                🏫 {{ session.school.name }}
                                            </div>
                                        </div>
                                        <div v-if="session.organization_logo">
                                            <label class="text-sm font-medium text-gray-700">Organization Logo</label>
                                            <div class="mt-2">
                                                <img :src="session.organization_logo" alt="Organization Logo"
                                    ...
                                    <div v-if="session.location_highlights && session.location_highlights.length > 0" class="mt-4">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <span
                                                ...
                                                :key="highlight"
                                                class="inline-flex items-center bg-orange-100 text-orange-800 text-sm px-3 py-1 rounded-full border border-orange-200"
                                            >
                                                ✨ {{ highlight }}
                                            </span>
                                        </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-6">
                                    ...
                                    <div class="flex justify-center">
                                        ...
                                        <span v-else 
                                            class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-orange-100 text-orange-800 border border-orange-200">
                                            ⚡ Essentials Program
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-6">
                                    ...
                                    <div class="space-y-3">
                                        <Link
                                            :href="route('admin.training-camp-sessions.duplicate', session.id)"
                                            method="post"
                                            class="w-full inline-flex items-center justify-center px-4 py-2 bg-orange-100 hover:bg-orange-200 text-orange-800 font-medium rounded-lg transition-colors"
                                        >
                                            📋 Duplicate Session
                                        </Link>
                                        <button

...
<template>
    ...
    <Head title="Edit Training Camp Session" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Edit Training Camp Session</h2>
                        ...
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                ...
                                <div>
                                    <InputLabel for="program_id" value="Training Camp Program" />
                                    <select id="program_id" v-model="form.program_id"
                                        ...
                                        <option v-for="camp in trainingCamps" :key="camp.id" :value="camp.id">
                                            {{ camp.title }} (Base: ${{ camp.base_price }})
                                        </option>
                                    </select>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="new_school_name" v-model="form.new_school_name" type="text"
                                            ...
                                            class="mt-1 block w-full" placeholder="e.g., Mountain Adventure Academy" 
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                                <h3 class="text-lg font-semibold text-green-900 mb-4">⛰️ Location Details</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="start_date" v-model="form.start_date" type="date"
                                            class="mt-1 block w-full" />
                                        <div class="mt-1 text-xs text-gray-600">For multi-day camps</div>
                                    ...
                                    <!-- <div>
                                        ...
                                        <div class="mt-1 text-xs text-gray-600">
                                            Leave empty to use training camp base price
                                        </div>
